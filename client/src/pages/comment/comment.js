      ...
      <View className="comment">
        <View className="comment-container at-row at-row__justify--center" style="width:100%">
          <Textarea
            ...
            style="width:80%;min-height:50px;padding:20rpx;background:#fff;"
            placeholder="请输入您的评价"
          ></Textarea>
        </View>
        <View className="return-btn-container at-row at-row__justify--center">
          <View onClick={this.addComment.bind(this)} className="return-btn">
            发表评价
          </View>
        </View>
      </View>
    ...
    return (
      <View>
        ...
        <View className="rate at-row at-row__justify--center">
          <AtRate size={30} value={rate} onChange={this.handleRateChange.bind(this)} />
        </View>
      </View>
    );
  }
